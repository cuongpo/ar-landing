<template>
  <section class="gallery-section" id="showcases">
      ...
      <div class="mixitup-gallery">
        ...
        <div class="filter-list row">
          ...
          <div class="gallery-item mix all web-design col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box">
              <figure class="image"><img src="/images/gallery/1.gif" alt=""></figure>
              <a href="/images/gallery/1.gif" class="lightbox-image overlay-box"
          ...
          <div class="gallery-item mix all photography web-design col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box">
              <figure class="image"><img src="/images/gallery/2.gif" alt=""></figure>
              <a href="/images/gallery/2.gif" class="lightbox-image overlay-box"
                 data-fancybox="gallery"></a>
              <div class="cap-box">
                <div class="cap-inner">
                  <div class="cat"><span>Graphic</span></div>
                  <div class="title">
                    <h5><nuxt-link to="/">Fimlor Experience</nuxt-link></h5>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="gallery-item mix all branding web-design col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box">
              <figure class="image"><img src="/images/gallery/3.gif" alt=""></figure>
              <a href="/images/gallery/3.gif" class="lightbox-image overlay-box"
                 data-fancybox="gallery"></a>
              <div class="cap-box">
                <div class="cap-inner">
                  <div class="cat"><span>Graphic</span></div>
          ...
          <div class="gallery-item mix all branding illustration col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box">
              <figure class="image"><img src="/images/gallery/4.gif" alt=""></figure>
              <a href="/images/gallery/4.gif" class="lightbox-image overlay-box"
                 data-fancybox="gallery"></a>
              <div class="cap-box">
                <div class="cap-inner">
                  <div class="cat"><span>Graphic</span></div>
          ...
          <div
            ...
            <div class="inner-box">
              <figure class="image"><img src="/images/gallery/5.gif" alt=""></figure>
              <a href="/images/gallery/5.gif" class="lightbox-image overlay-box"
                 data-fancybox="gallery"></a>
              <div class="cap-box">
                <div class="cap-inner">
                  <div class="cat"><span>Graphic</span></div>
          ...
          <div class="gallery-item mix all illustration photography col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box">
              <figure class="image"><img src="/images/gallery/6.gif" alt=""></figure>
              <a href="/images/gallery/6.gif" class="lightbox-image overlay-box"
                 data-fancybox="gallery"></a>
              <div class="cap-box">
                <div class="cap-inner">
                  <div class="cat"><span>Graphic</span></div>
